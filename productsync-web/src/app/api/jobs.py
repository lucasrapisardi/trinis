...
from app.schemas.schemas import JobCreate, JobOut, JobLogOut
...
async def create_job(
    ...
    # Enqueue Celery task
    # from app.tasks.sync import run_sync_pipeline
    # task = run_sync_pipeline.delay(str(job.id), str(tenant.id))
...
async def retry_job(
    ...
    # from app.tasks.sync import run_sync_pipeline
    # task = run_sync_pipeline.delay(str(new_job.id), str(tenant.id))
